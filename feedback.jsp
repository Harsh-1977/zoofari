...
<head>
  ...
  <link href="css/feedback_css.css" rel="stylesheet" />
</head>
...
<body>
  ...
  <section class="feedback-section">
    ...
    <div class="feedback-container">
      ...
      <h2>How Was Your Safari Experience?</h2>
      <p>Select your experience & rate us</p>

      <form action="forms/feedback_process.jsp" method="post">
        <!-- Experience Images -->
        ...
        <!-- ⭐ Star Rating -->
        <label class="rating-title">Overall Rating</label>

        <div class="rating-box">
          <input type="radio" name="rating" id="rate5" value="5">
          <label for="rate5">&star;</label>

          <input type="radio" name="rating" id="rate4" value="4">
          <label for="rate4">&star;</label>

          <input type="radio" name="rating" id="rate3" value="3">
          <label for="rate3">&star;</label>

          <input type="radio" name="rating" id="rate2" value="2">
          <label for="rate2">&star;</label>

          <input type="radio" name="rating" id="rate1" value="1">
          <label for="rate1">&star;</label>
        </div>

        <!-- Feedback Text -->
        <textarea placeholder="Share your safari experience..." name="message" required></textarea>
