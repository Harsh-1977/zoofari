...
<head>
    ...
    .btn-insert:hover{
        background: linear-gradient(135deg, #6d7b8a, #6d7b8a);
        color: #fff;
        text-decoration: none;
    ...
    <!-- <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn"
      ...
      <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
        <div class="navbar-nav ms-auto">
          ...
          <a href="service_display.jsp" class="nav-item nav-link active">Services</a>
...
<h2 class="text-center mb-4">Services</h2>
    <a href="add_service.jsp" class="btn btn-insert">+ Add Service</a>
...
%>
        <tr>
            <td><%=rs.getInt("Id")%></td>
            <td>
                <img src="../<%=rs.getString("icon")%>" width="60" height="60">
            </td>
            <td><%=rs.getString("title")%></td>
            <td><%=rs.getString("description")%></td>
            <td>
                <a href="../crud/editService.jsp?id=<%=rs.getInt("id")%>" 
                   class="btn btn-success btn-sm">Edit</a>

                <a href="../crud/deleteService.jsp?id=<%=rs.getInt("id")%>" 
