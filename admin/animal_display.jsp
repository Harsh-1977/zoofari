    ...
    <!-- <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn"
      ...
      <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
        <div class="navbar-nav ms-auto">
          ...
          <a href="animal_display.jsp" class="nav-item nav-link active">Our Animals</a>
...
<h2 class="text-center mb-4">Animals</h2>
    <a href="add_animal.jsp" class="btn btn-insert">+ Add Animal</a>
...
%>
        <tr>
            <td><%=rs.getInt("Id")%></td>
            <td>
                <img src="../<%=rs.getString("image")%>" width="60" height="60">
            </td>
            <td><%=rs.getString("animal_name")%></td>
            <td><%=rs.getString("animal_type")%></td>
            <td>
                <a href="../crud/editAnimal.jsp?id=<%=rs.getInt("id")%>" 
                   class="btn btn-success btn-sm">Edit</a>

                <a href="../crud/deleteAnimal.jsp?id=<%=rs.getInt("id")%>" 
