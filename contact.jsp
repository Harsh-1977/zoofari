    ...
    <div class="container">
        ...
        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
          <div class="h-100 bg-light d-flex align-items-center p-5">
            ...
            <div class="ms-4">
              ...
              <h5 class="mb-0">Zoofari, Sasan Gir, Gujarat</h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
          <div class="h-100 bg-light d-flex align-items-center p-5">
            ...
            <div class="ms-4">
              ...
              <h5 class="mb-0">+91 99099 88066</h5>
            </div>
          </div>
        </div>
        <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
          <div class="h-100 bg-light d-flex align-items-center p-5">
            ...
            <div class="ms-4">
              ...
              <h5 class="mb-0">info@zoofari.com</h5>
            </div>
          </div>
        </div>
      </div>
      <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
          ...
          <form action="forms/contact_process.jsp" method="post">
            <div class="row g-3">
              <div class="col-md-6">
